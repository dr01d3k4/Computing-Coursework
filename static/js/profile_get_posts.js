...
(function() {
  $(document).ready(function() {
    var $postReplyBox, $postReplyBoxAppendedToButton, $postReplyBoxCharactersRemaining, $postReplyBoxContent, $postReplyBoxFooter, $postReplyBoxPost, $postReplyBoxPostContainer, $postReplyBoxTextBox, $postTopLayer, $window, GET_POSTS_LENGTH, NO_POSTS_TIME, SHOW_TIME, UPDATE_TIME_SECONDS, WINDOW_BOTTOM_LOAD_NEW_POSTS_SCROLL, buildPostHtml, closePostReplyBox, detectScroll, getTopPostsApi, gotAmount, hideChildren, isTopLayerVisiblePost, loadNextPosts, loadingNext, maximumReplyLengthCharacters, onDeleteClicked, onPostReplyClicked, onPostReplyOpenClicked, onViewConversationClicked, onViewRepliesClicked, postReplyBoxAppendedToId, postReplyClicked, renderFirstPosts, topLayerVisiblePosts, viewRepliesPressed;
    $("html, body").animate({
      scrollTop: "0px"
    });
    GET_POSTS_LENGTH = 10;
    ...
    getTopPostsApi = viewingSelf ? "/social/api/get-posts-by-users-followed-by/" + loggedInUsername + "/" : "/social/api/get-posts-by/" + viewingUsername + "/";
