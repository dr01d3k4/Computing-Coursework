...
class UserProfileSettingsForm(forms.ModelForm):
	...
	website = forms.URLField(help_text = "Your website (optional):", required = False, max_length = 200);
	profile_image = forms.ImageField(help_text = "Select a profile image (optional):", required = False);
